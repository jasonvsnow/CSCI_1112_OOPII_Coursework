 ...
 * Author: Jason Snow
 * Date: 01/19/2021
 * This program is a modified version of the ClockPane class and DisplayClock class. The hands for the hour, minute, and
 * 	second now have boolean variables that can toggle their visibility, as well as getter and setter methods. The program
 * 	makes a clock with randomly generated hour (0-11) and minute (0-30) values before displaying a clock with only those 
 * 	hands visible.
 * 
 */
public class Exercise14_28 extends Application {
	...
	public void start(Stage primaryStage) {
		//randomly generate time to populate clock
		Calendar calendar = new GregorianCalendar();
		int ranHour = (int)(Math.random()*12);
		int ranMinute = (int)(Math.random()*31);
		int ranSecond = calendar.get(Calendar.SECOND);
		// Create a clock and a label
		ClockPane clock = new ClockPane(ranHour, ranMinute, ranSecond);
